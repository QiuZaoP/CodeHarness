...
export function loadConfig(environment: Environment = process.env) {
  ...
  return {
    ...
    maxModelOutputTokens: intEnv(environment, 'MAX_MODEL_OUTPUT_TOKENS', 64_000),
    ...
    maxImportArtifactFiles: intEnv(environment, 'MAX_IMPORT_ARTIFACT_FILES', 2_000),
    maxImportArtifactBytes: intEnv(environment, 'MAX_IMPORT_ARTIFACT_BYTES', 64 * 1024 * 1024),
